...
screen -d -m -S sxrConsoleClient ssh psana1502
screen -S sxrConsoleClient -X stuff 'cd /reg/neh/home/sioan/Desktop/experimentSpecificFiles/X229/screenCludgeDebugTool \n'
screen -S sxrConsoleClient -X stuff './runOnSXR.sh \n'

ssh psana1502 'screen -d -m -S screenTest ipython'
