...
#test for run w/ xtcav. Remember one...
#defaultDets.append(xtcavDetector())
#test !
print 'make tt det here'
defaultDets.append(ttRawDetector(env=ds.env()))
ttRawDict = {'refitData': True}
setParameter(defaultDets, ttRawDict , 'ttRaw')
print 'made tt det ere'
