...
#    def image_simulator(self,imagefunc) :
#        print "Custom image simulator called"
#        self.__camera.set_imagefunc(imagefunc)
    ...
    def __get_avg_projection(self,navg) :        
        ...
        # wait 3 second before capturing images
        #print "Sleep 3 seconds for camera"
        #time.sleep(3.0)
...
#    print "Setting custom image func"
#    zero_order_mono_auto_focus.image_simulator(ZeroOrderSim.image)
    
    zero_order_mono_auto_focus.scan_start_pos = -0.30
    zero_order_mono_auto_focus.scan_stop_pos = 0.0
    zero_order_mono_auto_focus.scan_delta = 0.005
