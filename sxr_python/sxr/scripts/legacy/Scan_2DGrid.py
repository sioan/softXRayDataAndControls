...
Usage:  
   Scan_2D.py  <motorpvname>  <from>  <to>  <npoints>
...
Two motors are used to scan over a 2D grid of points, defined by
...
point, record 20 DAQ events.
  ...
  Scan_2DGrid SXR:EXP:MMS:01 -10.0 10.0 4 SXR:EXP:MMS:02 -5 20 6 20 True
"""
...
daq.mesh2D(motor1,from1,to1,npoints1,
