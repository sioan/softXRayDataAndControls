...
def main(kill,myName):

	f = open('/reg/neh/home5/sioan/softXRayDataAndControls/myScripts/scriptConfigFiles/psusrhosts.cfg')
	q = Queue.Queue()
	if(kill):
		screenCommand = "killall -v "+myName
	else:
		screenCommand = "ps -ef | grep -i "+myName+" | grep -v -e grep -e netps"
...
if __name__ == '__main__':
	...
	myParser.add_argument('-n','--name',type=str,help='name of process to search for')
