...
screen -S sxrConsoleClient -X stuff 'cd /reg/neh/home/sioan/softXRayDataAndControls/myScripts/psanaShmemToEpics \n'
screen -S sxrConsoleClient -X stuff './runOnSXR.sh \n'

screen -d -m -S monNodeShMem ssh daq-sxr-mon06
screen -S monNodeShMem -X stuff 'cd /reg/neh/home/sioan/softXRayDataAndControls/myScripts/psanaShmemToEpics \n'
screen -S monNodeShMem -X stuff './runOnMonNode.sh \n'

screen -d -m -S pyIOC ssh sxr-console
screen -S pyIOC -X stuff 'cd /reg/neh/home/sioan/softXRayDataAndControls/myScripts/psanaShmemToEpics \n'
...
screen -S twoPulseFitter -X stuff 'cd /reg/neh/home/sioan/softXRayDataAndControls/myScripts/psanaShmemToEpics \n'
